...
Web admin sederhana berbasis **Streamlit** untuk membantu UMKM Ayam Nyakot mencatat pesanan ayam geprek, memantau pengantaran, dan mengecek pembayaran ongkir.
...
4. Tracking status pengantaran
5. Update status pembayaran ongkir
6. Edit data pesanan
