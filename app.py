        ...
        sample = pd.DataFrame(
            [
                ...
                },
                {
                    ...
                    "total_pesanan": 10000,
                    "ongkir": 5000,
                    "metode_pesanan": "Diantar Ojek Online",
                    "nama_petugas": "Driver Online",
...
st.markdown(
    ...
    <div class="hero">
        ...
        <p>Web admin untuk mencatat pesanan ayam geprek, memantau pesanan, dan mengecek pembayaran ongkir bila ada pengantaran.</p>
    </div>
    """,
    unsafe_allow_html=True
)
...
# =========================
    ...
    with st.form("form_tambah_pesanan", clear_on_submit=True):
        ...
        with c1:
            ...
            level = st.selectbox("Level Pedas", TINGKAT_PEDAS)
        ...
        with c2:
            ...
            nama_petugas = st.text_input("Nama Kurir / Petugas / Petugas")
...
# =========================
    ...
    keyword = st.text_input("Masukkan kata kunci pencarian", placeholder="Contoh: AN-20260508-1001 / Rina / Pedas")
